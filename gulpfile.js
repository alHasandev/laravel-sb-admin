...
function modules() {
  ...
  var bootstrapJS = gulp.src('./node_modules/bootstrap/dist/js/*')
    .pipe(gulp.dest(BASE_DIR + '/vendor/bootstrap/js'));
  // Bootstrap SCSS
  var bootstrapSCSS = gulp.src('./node_modules/bootstrap/scss/**/*')
    .pipe(gulp.dest(BASE_DIR + '/vendor/bootstrap/scss'));
  // ChartJS
  var chartJS = gulp.src('./node_modules/chart.js/dist/*.js')
    .pipe(gulp.dest(BASE_DIR + '/vendor/chart.js'));
  // dataTables
  ...
  var jquery = gulp.src([
    ...
    .pipe(gulp.dest(BASE_DIR + '/vendor/jquery'));
